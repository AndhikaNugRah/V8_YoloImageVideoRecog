...
with main_container:
    ...
    upload_image = st.file_uploader(label="Upload Your Image & Detect Here :", type=["png", "jpg", "jpeg"])
    upload_video = st.file_uploader(label="Upload Your Video & Detect Here :", type=["mp4"])
...
if upload_image and upload_image.type.endswith(('jpg', 'png', 'jpeg')) and upload_video is not None:
...
if upload_video is not None:
    action_file.play_stored_video(numb_confidence, model, upload_video)